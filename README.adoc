...
= Externalized Configration - Fuse Booster

== Overview
The Externalized Configration mission provides a basic example of using a ConfigMap (or a properties file in the case of standalone deployments) to externalize configuration used in an Apache Camel route. 
